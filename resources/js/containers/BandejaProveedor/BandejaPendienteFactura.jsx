  ...
  const getAsignaciones = async (estatusActividad) => {
    ...
    res.data.forEach((doc) => {
      nuevo.push({
        ...
        revision: (
          <MDBLink
            to={`/bandejaProveedor/${doc.id_asignacion_actividades}/revision`}
        ...
        adjuntarFactura: (
          <MDBLink
            to={`/bandejaProveedor/${doc.id_asignacion_actividades}/adjuntarFactura`}
  ...
  return (
    <div className="BandejaAct">
      ...
      <div className="d-flex ">
        ...
        <Link
          to={`/bandejaProveedor/pendientePago`}
          type="button"
